...
#	#ArrowTop 17
	...
	#Arrow Middle 17
	if time_elapsed > 0:
		if time_elapsed > 45867 && time_elapsed < 45887:
			flagMiddle17 = true
...
#	#ArrowTop 22
	...
	#Arrow Bottom 18
	if time_elapsed > 1000:
		if time_elapsed > 65093 && time_elapsed < 65113:
			flagDown18 = true
...
#	#ArrowTop 24
	if time_elapsed > 1000:
		if time_elapsed > 71843 && time_elapsed < 71863: #|| time_elapsed > 9000 && time_elapsed < 9020:
			flagUp24 = true
